...
main = do
    ...
    case parseExpression entrada of
        Right expressao -> do
            ...
            let cnfExpr = toCNF expressao
            putStrLn $ "Expressão em Forma Normal Conjuntiva (CNF): " ++ toNormal cnfExpr

            case toHornClauses cnfExpr of
                Right hornClauses -> putStrLn $ "Cláusulas de Horn: " ++ show hornClauses
                Left erro -> putStrLn $ "Erro ao converter para cláusulas de Horn: " ++ erro
